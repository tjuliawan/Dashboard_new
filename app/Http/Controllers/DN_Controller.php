        ...
        $query = "
            with tbl as(
                ...
                FROM
                    ...
                    tr_tagih_sales_DN_d otagissalesdn on otranssalesdn.Sales_DN_Code = otagissalesdn.salesdntagih_Sales_dn_codeheader
            ...
            SELECT distinct
                ...
                isnull( cab_code1, dn.rec_areacode ) cab_code , trash_data
            FROM
                tbl
                LEFT JOIN tr_kp_order_DN dn ON kporderdn_DN_final_code = Sales_DN_Code_d 
                left join tr_tagih_sales_DN_d tg on tbl.Sales_DN_Code_d = tg.salesdntagih_Sales_dn_code 
            ORDER BY
                Sales_DN_date DESC
        ";
        // dd($query);
