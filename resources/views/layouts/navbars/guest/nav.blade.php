  ...
  <div class="container-fluid {{ (Request::is('static-sign-up') ? 'container' : 'container-fluid') }}">
    ...
    <div class="collapse navbar-collapse" id="navigation">
      ...
      <ul class="navbar-nav d-lg-block d-none">
        <li class="nav-item">
          {{-- <a href="https://www.instagram.com/rohiiiiiddddd/" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}">my Instagram</a> --}}
          <a href="https:hgs.co.id" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-{{ (Request::is('static-sign-up') ? 'light' : 'dark') }}">Our Website</a>
        </li>
      </ul>
    </div>
  </div>
