    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ str_contains(Request::path(), 'Employee-management') ? 'active' : '' }}" href="{{ url('Employee-management') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-users ps-2 pe-2 text-center text-dark {{ str_contains(Request::path(), 'Employee-management') ? 'text-white' : 'text-dark' }}" aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Emp Management</span>
                </a>
            </li> --}}
            ...
            {{-- <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">SKU pages</h6>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ str_contains(Request::path(), 'SKU-management') ? 'active' : '' }}" href="{{ url('SKU-management') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-clipboard-list ps-2 pe-2 text-center text-dark {{ str_contains(Request::path(), 'SKU-management') ? 'text-white' : 'text-dark' }}" aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">SKU Management</span>
                </a>
            </li> --}}
            {{-- <li class="nav-item">
