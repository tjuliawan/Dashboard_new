  ...
  <footer class="footer py-5">
    <div class="container">
      ...
      <div class="col-lg-8 mb-4 mx-auto text-center">
          {{-- <a href="https://hgs.co.id" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              Company
          </a>
          <a href="https://www.instagram.com/rohiiiiiddddd/" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
              About Us
          </a>
        ...
        {{-- @if (!auth()->user() || \Request::is('static-sign-up')) 
          <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
              ...
              <a href="https://www.instagram.com/rohiiiiiddddd/" target="_blank" class="text-secondary me-xl-4 me-4">
              ...
              <a href="https://github.com/mrohid127" target="" class="text-secondary me-xl-4 me-4">
