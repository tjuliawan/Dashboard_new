...
@section('title', 'DN System - List DN')
@section('css')
    <style>
        .loader {
            width: 120px;
            ...
            function initializeDataTable() {
                ...
                table = $('#list_kwitansi_table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'status_kwitansi',
                            name: 'status_kwitansi',
                                ...
                                if (data === "1" || data === 1) {
                                    return `
                                        <span class="badge bg-gradient-success" title="Sudah dibayar" style=" color: #ffffff; border-radius: 10px; padding: 5px 8px; font-size: 11px;">
                                            <i class="fa-solid fa-circle-check"></i> Dibuat
                                        </span>`;
    ...
    <div>
        <div class="row">
            ...
            <div class="col-auto mb-3">
                <div class="card mb-3" style="width: 260px">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-9">
                                <div class="numbers">
                ...
                <div class="card mb-3" style="width: 250px">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-9">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">PPH Sdh Dibayar</p>
                                    <h6 class="font-weight-bolder mb-0">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-9">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">PPH Blm Dibayar</p>
                                    <h6 class="font-weight-bolder mb-0">
