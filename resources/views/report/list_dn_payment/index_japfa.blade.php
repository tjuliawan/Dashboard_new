        ...
        $(document).ready(function() {
            ...
            function initializeDataTable() {
                ...
                table = $('#list_kwitansi_table').DataTable({
                    ...
                    serverSide: false,
                    ajax: {
                        url: '/report/get/list_dn_payment_japfa',
                        type: 'GET',
                        dataSrc: '',
                        data: {
                            startDate: startDate,
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                if (data === "1" || data === 1) {
                                    ...
                                    return `
                                        <span class="badge bg-gradient-secondary" title="Belum dibayar" style="color: #ffffff; border-radius: 10px; padding: 5px 8px; font-size: 11px;">
                                             Belum Tersedia
                                        </span>`;
                                } else {
                                    return '';
            ...
            $(document).on('click', '.btn_print', function() {
                ...
                kode = row.find('td:eq(2)').text();
                // alert(kode);
                var url = '/cetak-pdf/payment-japfa?code=' + encodeURIComponent(kode);
