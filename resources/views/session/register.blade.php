                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" method="POST" action="/register">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="Full Name" name="name" id="name" aria-label="Name" value="{{ old('name') }}">
                                    @error('name')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    <select name="ms_divisi" id="ms_divisi" class="form-select">
                                ...
                                <div class="mb-3">
                                    <select name="sub_divisi" id="sub_divisi" class="form-select">
                                        <option value="">Pilih Sub Divisi</option>
                                        @php
                                            $subdivisiList = ['AR Staff', 'Audit Staff', 'Tax Staff', 'Supervisor', 'Manager'];
                                        @endphp
                                        @foreach ($subdivisiList as $subDivisi)
                                            <option value="{{ $subDivisi }}" {{ old('sub_divisi') == $subDivisi ? 'selected' : '' }}>{{ $subDivisi }}</option>
                                        @endforeach
                                    </select>
                                    @error('sub_divisi')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                ...
                                <div class="form-check form-check-info text-left">
                                    <input class="form-check-input" type="checkbox" name="agreement" id="flexCheckDefault" {{ old('agreement') ? 'checked' : '' }}>
