            ...
            <div class="row gx-4">
                <div class="col-auto">
                    ...
                    <div class="avatar avatar-xl position-relative">
                        <div class="position-relative w-100" style="aspect-ratio: 1 / 1; max-width: 150px; border-radius: 1rem; overflow: hidden;">
                            @if ($imageSrc)
                                <img src="{{ $imageSrc }}" alt="profile_image" style="width: 100%; height: 100%; object-fit: cover;" class="shadow-sm">
                            @else
                                <div class="d-flex align-items-center justify-content-center w-100 h-100 bg-light shadow-sm" style="width: 100%; height: 100%;">
